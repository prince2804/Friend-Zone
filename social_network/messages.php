		  ...
		  $run_user=mysqli_query($con, $user);
			while($row_user=mysqli_fetch_array($run_user)){
			 	...
			 	<div class='container-fluid'>
			 		<a style='text-decoration:none; cursor:pointer;color :#3897F0;' href='
			 		messages.php?u_id=$user_id'>
			 			<img src='users/$user_image' class='img-circle' width='90px' height='80px' title='$user_name'><strong>&nbsp $first_name $last_name</strong><br><br>
			 		</a>
			 	</div>
			 	";
			}
	...
	<div class="col-sm-6">
		<div class="load_msg" id="scroll_messages">
			...
			<div id='loaded_msg'>
				...
				else if($user_from == $user_to_msg AND $user_to == $user_from_msg){echo"<div class='message' id='green' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}
					?>
				</p>
			</div>
					...
					<div class='row'>
						...
						<div style='background-color:#e6e6e6;' class='col-sm-9'>
							...
							<ul class='list-group'>
								...
								<li class='list-group-item' title='User Registration'>$register_date</li>
							</ul>
						</div>
						<div class='col-sm-1'>
						</div>
