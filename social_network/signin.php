...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;"><img src="images/Logo_name.png"width="500px" height="100px"></h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to Friend Zone</strong></h3>
			</div>
			<div class="l-part">
